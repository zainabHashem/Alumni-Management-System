...
$Events = $EventController->showPost("question");
$user = $EventController->showUser();
$totalreact = $EventController->totalReact(0);
$SavedEvents = $EventController->showSavedPosts("question");
if (isset($_POST['createPost'])) {
  if (!empty($_POST['postDescription']) || !empty($_POST['uploadedLink']) || !empty($_POST['uploadedFile']) || !empty($_POST['uploadedImage']) ) {
    ...
    $ques = new Question("null", "$description","$image","$link","$file");
    if ($EventController->insertPost($ques,$ques->getPostType())) {
                    ...
                    foreach ($Events as $event) {
                      if ($event["validation"] == "accepted") {
                        ...
                        <div class="post">
                          ...
                          <!-- <div class="col-sm-6">
                                <img class="img-fluid" src="../../Images/microsoft question.jpg" alt="Photo">
                              </div> -->
                          </p>
