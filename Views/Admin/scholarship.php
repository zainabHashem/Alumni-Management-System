...
$Events = $EventController->showPost("scholarship");
$user = $EventController->showUser();
$totalreact = $EventController->totalReact(0);
$SavedEvents = $EventController->showSavedPosts("scholarship");
if (isset($_POST['createPost'])) {
  if (!empty($_POST['postDescription']) || !empty($_POST['uploadedLink']) || !empty($_POST['uploadedFile']) || !empty($_POST['uploadedImage']) ) {
    ...
    $scho = new Scholarship("null", "$description","$image","$link","$file");
    if ($EventController->insertPost($scho,$scho->getPostType())) {
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Scholarship page</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  ...
                  <div class="user-block">
                    <div class="user-block">
                      <!--<img class="img-circle img-bordered-sm" src="<?php echo $user[0]["userimage"]   ?>" alt="user image">
                      <span class="username">
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    foreach ($Events as $event) {
                      if ($event["validation"] == "accepted") {
                        ...
                        <div class="post">
                          <div class="user-block">
                            <img class="img-circle img-bordered-sm" src="../dist/img/<?php echo $event["userimage"] ?>"
                              alt="user image">
                            <span class="username">
                              <a href="#">
                          ...
                          <!-- <div class="col-sm-6">
                                <img class="img-fluid" src="../../Images/microsoft scholarship.jpg" alt="Photo">
                              </div> -->
                          </p>
                          ...
                          foreach($comments as $comment){
                            ?>
                            <div class="user-block">
                            <img class="img-circle img-bordered-sm" src="<?php echo $comment["userimage"] ?>" alt="user image">
                  ...
                  <div class="tab-pane" id="timeline">
                    <?php foreach ($SavedEvents as $savedEvent) {
                      if ($savedEvent["userid"] == $_SESSION["userId"]) {
                        ...
                        <div class="post">
                          <div class="user-block">
                            <img class="img-circle img-bordered-sm" src="<?php echo $savedEvent["userimage"] ?>"
                              alt="user image">
                            <span class="username">
                              <a href="#">
                          ...
                          <p>
                            ...
                            ?>
                            <?php
                            if ($savedEvent["postimage"] == !null) {
                              ?>
                            <div class="col-sm-6">
                              <img class="img-fluid" src="<?php echo $savedEvent["postimage"] ?>" alt="Photo">
                            </div>
                            <?php
                            }
                            ?>
                            ...
                            if (!empty($event["uploadedimage"])) {
                              ?>
                            <div class="col-sm-6">
                              <img class="img-fluid" src="../dist/img/<?php echo $savedEvent["uploadedimage"]; ?>" alt="Photo">
                            </div>
                            <?php
                            }
                            ?>
