...
$Events = $EventController->showPost("event");
$user = $EventController->showUser();
$totalreact = $EventController->totalReact(0);
$SavedEvents = $EventController->showSavedPosts("event");
if (isset($_POST['createPost'])) {
  if (!empty($_POST['postDescription']) || !empty($_POST['uploadedLink']) || !empty($_POST['uploadedFile']) || !empty($_POST['uploadedImage']) ) {
    ...
    $event = new Event("null", "$description","$image","$link","$file");
    if ($EventController->insertPost($event,$event->getPostType())) {
                        ...
                        <div class="post">
                          ...
                          <span class="float-right">
                            <a href="#" class="link-black text-sm">
                              <i class="far fa-comments mr-1"></i> Comments</a>
                          </span>
                          </p>
                          ...
                          foreach($comments as $comment){
                            ?>
                            <div class="user-block">
                            <img class="img-circle img-bordered-sm" src="../dist/img/<?php echo $event["userimage"] ?>" alt="user image">
